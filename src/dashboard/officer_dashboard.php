            ...
            <div class="container-fluid d-flex justify-content-end align-items-center"
              ...
              <div class="dropdown">
                <a href="#" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown"
                  ...
                  <img class="border border-dark rounded-circle" src="<?php echo !empty($profile_picture) ? 'uploads/' . htmlspecialchars($profile_picture) : '../user/uploads/default.png'; ?>" 
                            alt="Profile Image" 
                            id="profilePreview"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li><a class="dropdown-item" href="../user/profile.php"><i class="bx bx-user"></i> My Profile</a>
                  </li>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="organization-card p-4 rounded shadow-sm bg-white border mb-4">
                ...
                <img class="organization-logo me-3" src="<?= !empty($org_logo) ? '../organization_management/uploads/' . $org_logo : '../organization_management/uploads/default_logo.png' ?>" alt="<?= $org_name ?> Logo" />
                <div class="organization-details">
                    <p class="text-muted small-text mb-1">Name of Student Organization</p>
                    <h1 class="fw-semibold h5 mb-2"><?= htmlspecialchars($org_name) ?></h1>
                    <div class="d-flex gap-5">
                        <div>
                            <p class="text-muted small-text mb-1">No. of Members</p>
                            <h1 class="fw-semibold h6"><?= htmlspecialchars($org_members) ?></h1>
                        </div>
                        <div>
                            <p class="text-muted small-text mb-1">Status</p>
                            <h1 class="fw-semibold h6"><?= htmlspecialchars($org_status) ?></h1>
                        </div>
                    </div>
                </div>
            </div>
              ...
              <div class="col-md-4 mb-3">
                <div class="card financial-card p-3 shadow-sm bg-purple-200 mx-2">
                  ...
                  <div class="d-flex align-items-center">
                    <h1 class="fw-bold" style="margin-left: 2px;"><?php echo number_format($balance, 2); ?></h1>
