...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <div class="container-fluid d-flex justify-content-end align-items-center"
                            ...
                            <button id="notificationBtn" class="btn btn-transparent position-relative">
                                <lord-icon
                            ...
                            <div id="notificationDropdown" class="dropdown-menu p-2 shadow">
                                ...
                                <p id="noNotifications" class="text-center text-muted mt-2 d-none">
            ...
            <script src="js/budget_approvals copy.js"></script>
            <script>
