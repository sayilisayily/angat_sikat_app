        ...
        <nav class="sidebar-nav mx-4">
            <ul id="sidebarnav">
                <li class="sidebar-item">
                    <a class="sidebar-link" href="../dashboard/officer_dashboard.php">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="../budget_management/budget_overview.php">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="../transactions/transactions.php">
                ...
                <li class="sidebar-item profile-container">
                    <a class="sidebar-link" href="../user/profile.html">
