    ...
    <!-- DataTables CSS for table formatting within Bootstrap -->
    <link href="https://cdn.datatables.net/2.1.7/js/dataTables.js" rel="stylesheet">

    <!-- jQuery library for JavaScript functions and AJAX requests -->
